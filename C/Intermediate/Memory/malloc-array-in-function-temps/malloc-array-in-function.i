...
# 2 "../malloc-array-in-function.c" 2
...
# 3 "../malloc-array-in-function.c" 2
...
# 4 "../malloc-array-in-function.c" 2
...
# 5 "../malloc-array-in-function.c" 2


# 6 "../malloc-array-in-function.c"
...
int main()
{
 ...
 long int arr_length = 1000000000;
    long int size_bytes = arr_length * sizeof(int);

 int* nums = create_array_pointer(arr_length);

 if (nums == 
# 48 "../malloc-array-in-function.c" 3 4
            ((void *)0)
# 48 "../malloc-array-in-function.c"
                )
  exit(0);
